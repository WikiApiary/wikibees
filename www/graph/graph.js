window.Chart = function(targetDiv, id, defaultGraph) {
  ...
  var _graphs = [
    // Basic graphs
    {
      ...
      path: "/apiary/data/articles.php?id=" + _id
    },
    {
      id: "edits",
      name: "Edits",
      ...
      path: "/apiary/data/edits.php?id=" + _id
    },
    {
      id: "users",
      name: "Users",
      ...
      path: "/apiary/data/users.php?id=" + _id
    },
    {
      id: "jobs",
      name: "Jobs",
      ...
      path: "/apiary/data/jobs.php?id=" + _id
    },
    {
      id: "images",
      name: "Images",
      ...
      path: "/apiary/data/images.php?id=" + _id
    },
    {
      id: "response-time",
      name: "Response Time",
      ...
      path: "/apiary/data/response_timer.php?id=" + _id
    },
    // SMW Graphs
    {
      id: "propcount",
      ...
      path: "/apiary/data/propcount.php?id=" + _id
    },
    {
      id: "properties",
      name: "SMW Properties",
      ...
      path: "/apiary/data/properties.php?id=" + _id
    },
    {
      id: "errorcount",
      ...
      path: "/apiary/data/smwerrorcount.php?id=" + _id
    },
    // SMW Usage graphs
    {
      id: "queries",
      ...
      path: "/apiary/data/smwqueries.php?id=" + _id
    },
    {
      id: "querypages",
      ...
      path: "/apiary/data/smwquerypages.php?id=" + _id
    },
    {
      id: "querysize",
      ...
      path: "/apiary/data/smwquerysize.php?id=" + _id
    },
    {
      id: "queryformat",
      ...
      path: "/apiary/data/smwqueryformat.php?id=" + _id
    }
